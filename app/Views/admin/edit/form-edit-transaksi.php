                        ...
                        <form action="/edit/edittransaksi/<?= $id ?>" method="POST">
                            ...
                            <div class="card-body">
                                <div class="form-group form-show-validation row">
                                    <label for="idpenjualan" class="col-lg-3 col-md-3 col-sm-4 mt-sm-2 text-right">ID
                                        Invoice <span class="required-label">*</span></label>
                                ...
                                <div class="form-group form-show-validation row">
                                    <label for="nama_produk" class="col-lg-3 col-md-3 col-sm-4 mt-sm-2 text-right">Nama
                                        Produk <span class="required-label">*</span></label>
                                    <div class="col-lg-7 col-md-9 col-sm-8">
                                        <input type="text" class="form-control" id="nama_produk" name="nama_produk"
                                            placeholder="" value="<?= $data['nama_barang'] ?>" disabled>
                                    </div>
                                </div> <!-- end nama produk -->
                                ...
                                <div class="form-group form-show-validation row">
                                    ...
                                    <div class="col-lg-7 col-md-9 col-sm-8">
                                        <input type="text" class="form-control" id="tgl_penjualan" name="tgl_penjualan"
                                            placeholder="" value="<?= $data['tgl_penjualan'] ?>" disabled>
                                    </div>
                                </div>
                                <!-- end waktu pemesanan -->
                                        ...
                                        <div class="selectgroup selectgroup-pills d-flex">
                                            ...
                                            <label class="selectgroup-item">
                                                <input type="radio" name="update_status" id="update_status"
                                                    class="selectgroup-input bg-red" value="<?= $status['idstatus']; ?>"
