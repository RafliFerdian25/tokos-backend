<?= $this->extend('auth/templatesauth/templateauth'); ?>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="password"
                                                ...
                                                akun__text name="pass_confirm"
                                                placeholder="<?= lang('Auth.repeatPassword') ?>" autocomplete="off">
                                        </div>
                                    </div>
                                    <button type="submit" class="btn btn-tokos btn-user btn-block">
                                        <?= lang('Auth.register') ?>
                                    </button>
                                </form>
                                <hr>
                                <div class="text-center akun__text">
                                    <a class="small"
                                        href="<?= route_to('login') ?>"><?= lang('Auth.alreadyRegistered') ?><?= lang('Auth.signIn') ?></a>
                                </div>
                            </div>
                        </div>
                    </div>
